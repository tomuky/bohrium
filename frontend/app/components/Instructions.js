        ...
        return (
            <div className={styles.area}>
                ...
                <div className={styles.content}>
                    ...
                    <InstructionsItem number="2" icon="/images/delegate2.png" text="Delegate session wallet" help="Delegating your session wallet allows you to still collect mining rewards and stake BOHR with your main wallet." completed={isDelegated}/>
                    <InstructionsItem number="3" icon="/images/dollar-sign.png" text="Fund session wallet" help="Your session wallet needs a little bit of ETH to pay for gas fees. Only keep small balances there." completed={isConnected && sessionBalance > 0}/>
