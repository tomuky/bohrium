        ...
        return (
            <div className={styles.area}>
                ...
                <div className={styles.content}>
                    ...
                    <InstructionsItem number="2" icon="/images/bolt.png" text="Open session wallet" help="This generates a wallet within memory that is not stored anywhere, allowing automatic transactions to be made on your behalf." completed={hasSessionWallet}/>
                    ...
                    <InstructionsItem number="4" icon="/images/dollar-sign.png" text="Fund session wallet" help="Your session wallet needs a little bit of ETH to pay for gas fees. Only keep small balances there." completed={isConnected && sessionBalance > 0}/>
